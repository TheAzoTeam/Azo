...
void Player::shutdown(){
	...
	for(auto eachSprite : m_walking_animation_sprites){
		if(eachSprite != nullptr){
			eachSprite = nullptr;
		}
	}

	for(auto eachSprite : m_jumping_animation_sprites){
		if(eachSprite != nullptr){
			eachSprite = nullptr;
		}
	}

	for(auto eachSprite : m_sliding_animation_sprites){
		if(eachSprite != nullptr){
			eachSprite = nullptr;
		}
	}

	for(auto eachSprite : m_dying_animation_sprites){
		if(eachSprite != nullptr){
			eachSprite = nullptr;
		}
	}
